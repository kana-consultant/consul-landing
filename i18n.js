...
const I18N = {
  id: {
    ...
    "trust.geo": "Termasuk 2 kementerian RI · klien di 🇺🇸 AS · 🇦🇺 Australia · 🇩🇪 Jerman · 🇸🇬 Singapura · 🇮🇩 Indonesia",
    ...
    "bukti.uc1ind": "Pendidikan Vokasi",
    "bukti.uc1t": "ATVETI",
    "bukti.uc1p": "Rekap data anggota & laporan kegiatan dikerjakan manual di spreadsheet — lambat dan rawan salah. Kami otomatiskan pengumpulan & penyusunan laporannya.",
    "bukti.uc1m": "Waktu laporan −30%",
    "bukti.uc2ind": "Layanan & Operasional",
    "bukti.uc2t": "URAI",
    "bukti.uc2p": "Follow-up dan koordinasi tersebar di banyak channel sehingga sering terlewat. Kami bangun alur follow-up otomatis yang terhubung ke data mereka.",
    "bukti.uc2m": "Efisiensi tim ▲",
    "bukti.uc3ind": "Hospitality",
    "bukti.uc3t": "Allogio",
    "bukti.uc3p": "Pertanyaan tamu menumpuk dan respon lambat di luar jam kerja. AI agent menjawab 24/7 dengan konteks bisnis, eskalasi ke tim hanya saat perlu.",
    "bukti.uc3m": "Respon < 1 menit, 24/7",
    "bukti.uc4ind": "Advisory & Finansial",
    "bukti.uc4t": "Vantage",
    "bukti.uc4p": "Data operasional terpencar sehingga keputusan lambat. Kami satukan ke satu dashboard ringkas dengan ringkasan otomatis.",
    "bukti.uc4m": "Keputusan lebih cepat",
    "bukti.hint": "Geser →",
  ...
  en: {
    ...
    "trust.geo": "Including 2 Indonesian ministries · clients in 🇺🇸 USA · 🇦🇺 Australia · 🇩🇪 Germany · 🇸🇬 Singapore · 🇮🇩 Indonesia",
    ...
    "bukti.uc1ind": "Vocational Education",
    "bukti.uc1t": "ATVETI",
    "bukti.uc1p": "Member data recaps & activity reports were done manually in spreadsheets — slow and error-prone. We automated the collection and report assembly.",
    "bukti.uc1m": "Report time −30%",
    "bukti.uc2ind": "Services & Operations",
    "bukti.uc2t": "URAI",
    "bukti.uc2p": "Follow-ups and coordination were scattered across channels and often missed. We built an automated follow-up flow wired to their data.",
    "bukti.uc2m": "Team efficiency ▲",
    "bukti.uc3ind": "Hospitality",
    "bukti.uc3t": "Allogio",
    "bukti.uc3p": "Guest questions piled up with slow after-hours replies. An AI agent answers 24/7 with business context, escalating only when needed.",
    "bukti.uc3m": "Reply < 1 min, 24/7",
    "bukti.uc4ind": "Advisory & Finance",
    "bukti.uc4t": "Vantage",
    "bukti.uc4p": "Operational data was scattered, slowing decisions. We unified it into one concise dashboard with automated summaries.",
    "bukti.uc4m": "Faster decisions",
    "bukti.hint": "Swipe →",
