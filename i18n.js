...
const I18N = {
  id: {
    ...
    "bukti.uc1p": "Masalah: penilaian Writing & Speaking IELTS/PTE manual — lambat, subjektif, siswa nunggu berhari-hari. Solusi kami: scoring AI berbasis rubrik resmi + feedback otomatis.",
    "bukti.uc1m": "Feedback: berhari-hari → < 60 detik",
    "bukti.uc2ind": "URAI",
    "bukti.uc2t": "Keputusan hiring berbasis bukti, bukan tebakan",
    "bukti.uc2p": "Masalah: asesmen talenta manual, subjektif, dan lama diinterpretasi. Solusi kami: platform psikometri tervalidasi + narasi rekomendasi otomatis yang siap dipakai HR.",
    "bukti.uc2m": "Asesmen: subjektif → terukur & terstandar",
    "bukti.uc4ind": "Vantage",
    "bukti.uc4t": "Intake pasien 24/7 dengan eskalasi krisis yang aman",
    "bukti.uc4p": "Masalah: antrean intake menumpuk, butuh respon cepat tapi aman. Solusi kami: AI intake assistant 24/7 yang menandai sinyal krisis dan eskalasi langsung ke staf.",
    "bukti.uc4m": "Intake: jam kerja → 24/7 otomatis",
    "bukti.uc5ind": "KUNCI",
    "bukti.uc5t": "Pipeline outbound yang menjalankan dirinya sendiri",
    "bukti.uc5p": "Masalah: tim sales boros jam buat riset prospek & tulis cold email. Solusi kami: AI SDR otonom — capture lead, riset website, profilkan, kirim 3 email personal, balas otomatis saat prospek merespons.",
  ...
  en: {
    ...
    "bukti.uc1p": "Problem: manual IELTS/PTE Writing & Speaking scoring — slow, subjective, students wait days. Our fix: AI scoring on the official rubric + automated feedback.",
    "bukti.uc1m": "Feedback: days → < 60 sec",
    "bukti.uc2ind": "URAI",
    "bukti.uc2t": "Evidence-based hiring decisions, not guesswork",
    "bukti.uc2p": "Problem: manual talent assessment that's subjective and slow to interpret. Our fix: a validated psychometric platform + auto-generated recommendation narratives, ready for HR.",
    "bukti.uc2m": "Assessment: subjective → measured & standardized",
    "bukti.uc4ind": "Vantage",
    "bukti.uc4t": "24/7 patient intake with safe crisis escalation",
    "bukti.uc4p": "Problem: intake queues piled up, needing fast but safe responses. Our fix: an AI intake assistant running 24/7 that flags crisis signals and escalates straight to staff.",
    "bukti.uc4m": "Intake: office hours → 24/7 automated",
    "bukti.uc5ind": "KUNCI",
    "bukti.uc5t": "An outbound pipeline that runs itself",
    "bukti.uc5p": "Problem: sales teams burn hours researching prospects and writing cold emails. Our fix: an autonomous AI SDR — capture a lead, research the site, profile it, send a 3-email personalized sequence, and auto-reply when prospects respond.",
