...
const I18N = {
  id: {
    ...
    "bukti.uc1p": "Penilaian Writing & Speaking IELTS/PTE yang manual itu lambat dan subjektif; siswa bisa nunggu berhari-hari. Kami bangun scoring AI berbasis rubrik resmi plus feedback otomatis, jadi hasilnya cepat dan konsisten.",
    "bukti.uc1m": "Feedback: berhari-hari → < 60 detik",
    "bukti.uc2ind": "HR / Talent Assessment",
    "bukti.uc2t": "Keputusan hiring berbasis bukti, bukan tebakan",
    "bukti.uc2p": "Asesmen talenta manual cenderung subjektif dan lama diinterpretasi. Kami susun platform psikometri tervalidasi plus narasi rekomendasi otomatis yang langsung siap dipakai tim HR.",
    "bukti.uc2m": "Asesmen: subjektif → terukur & terstandar",
    "bukti.uc4ind": "Healthcare / Mental Health",
    "bukti.uc4t": "Intake pasien 24/7 dengan eskalasi krisis yang aman",
    "bukti.uc4p": "Antrean intake pasien menumpuk dan butuh respon cepat tanpa mengorbankan keamanan. AI intake assistant melayani 24/7, menandai sinyal krisis, dan langsung mengeskalasi ke staf saat dibutuhkan.",
    "bukti.uc4m": "Intake: jam kerja → 24/7 otomatis",
    "bukti.uc5ind": "Sales / AI SDR",
    "bukti.uc5t": "Pipeline outbound yang menjalankan dirinya sendiri",
    "bukti.uc5p": "Tim sales boros berjam-jam buat riset prospek dan menulis cold email. KUNCI menjalankannya otomatis: menangkap lead, meriset website, memprofilkan, mengirim 3 email personal, lalu membalas sendiri saat prospek merespons.",
    "bukti.uc5m": "Outbound: manual → autopilot penuh",
    "bukti.hint": "Geser →",
  ...
  en: {
    ...
    "bukti.uc1p": "Manual IELTS/PTE Writing & Speaking scoring is slow and subjective, leaving students waiting days. We built AI scoring on the official rubric plus automated feedback, so results come fast and consistent.",
    "bukti.uc1m": "Feedback: days → < 60 sec",
    "bukti.uc2ind": "HR / Talent Assessment",
    "bukti.uc2t": "Evidence-based hiring decisions, not guesswork",
    "bukti.uc2p": "Manual talent assessment tends to be subjective and slow to interpret. We built a validated psychometric platform plus automated recommendation narratives that HR can use right away.",
    "bukti.uc2m": "Assessment: subjective → measured & standardized",
    "bukti.uc4ind": "Healthcare / Mental Health",
    "bukti.uc4t": "24/7 patient intake with safe crisis escalation",
    "bukti.uc4p": "Patient intake queues piled up and needed fast responses without compromising safety. An AI intake assistant runs 24/7, flags crisis signals, and escalates straight to staff when needed.",
    "bukti.uc4m": "Intake: office hours → 24/7 automated",
    "bukti.uc5ind": "Sales / AI SDR",
    "bukti.uc5t": "An outbound pipeline that runs itself",
    "bukti.uc5p": "Sales teams burn hours researching prospects and writing cold emails. KUNCI runs it autonomously: capturing leads, researching sites, profiling them, sending a 3-email personalized sequence, then replying on its own when prospects respond.",
    "bukti.uc5m": "Outbound: manual → full autopilot",
    "bukti.hint": "Swipe →",
